...
public class SunburstConfiguration: ObservableObject {
    ...
    @Published public var calculationMode: CalculationMode = .ordinalFromLeaves
    ...
    @Published public var innerRadius: CGFloat = 20.0
    ...
    public init(nodes: [Node], calculationMode: CalculationMode = .ordinalFromLeaves, nodesSort: NodesSort = .none) {
        self.nodes = nodes
